...
use Ttree\ISO\Domain\Repository\LanguageRepository;
use Ttree\ISO\Domain\Service\LanguageService;
 ...
 * @api
 */
class SelectLanguageViewHelper extends AbstractFormFieldViewHelper {
	...
	public function render() {
		...
		$options = $this->languageService->prepareLocalizedOptionsList();
		if (empty($options)) {
			$options = array('' => '');
		}
